...
vim.api.nvim_create_user_command("MasonInstallAll", function()
  vim.cmd "MasonInstall css-lsp html-lsp lua-language-server typescript-language-server stylua prettier tailwindcss-language-server emmet-language-server pyright black vue-language-server"
end, {})

vim.api.nvim_create_user_command("TSInstallAll", function()
  vim.cmd "TSInstall css yaml xml tsx json html lua javascript typescript markdown python vue toml"
end, {})
